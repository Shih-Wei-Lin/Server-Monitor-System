...
updates_data = [
        ...
        {"version": "1.2.5", "release_date": "2024-09-02", "features": [
            {"description": "Modify bug for update server usage data's source code."},
        ]},
        {"version": "1.2.4", "release_date": "2024-08-30", "features": [
        ...
        {"version": "1.2.3", "release_date": "2024-08-29", "features": [
            {"description": "Improve viewing experience on light backgrounds(Server Usage& Statistics)"},
        ]},
        {"version": "1.2.2", "release_date": "2024-08-28", "features": [
            {"description": "Improve Version Update resource code"},
        ]},
        {"version": "1.2.1", "release_date": "2024-08-27", "features": [
        ...
        {"version": "1.1.0", "release_date": "2024-08-26", "features": [
            {"description": "Change Account and User display interface"},
            {"description": "Add version_update page"}
        ]},
        {"version": "1.0.0", "release_date": "2024-08-20", "features": [
