    ...
    updates_data = [
        {
            ...
            "features": "Change the display logic of the statistics page to display all server CPU resources & You can decide to display information by clicking the label & Fix bug that won't update automatically",
        },
        {
            "version": "1.1.0",
            "release_date": "2023-08-26",
            "features": "Change Account and User display interface& add version_update page",
        },
        {
            "version": "1.0.0",
