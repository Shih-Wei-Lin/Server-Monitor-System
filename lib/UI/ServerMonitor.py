...
from lib.UI.tool.db_utils import (get_active_users_and_names, get_database_connection,
                           get_disk_c_usage, get_latest_average_timestamp,
    ...
    try:
        ...
        if wavelength is not None:
            ...
            calculated_frequency = (
                calculated_frequency_hz / unit_factors[frequency_unit]
            )
...
def show_calculator():
    ...
    with st.container():
        ...
        with col1:
            use_scientific_notation = st.checkbox(
                "Use Scientific Notation", value=False
            )
...
def main():
    ...
    try:
        ...
        st.sidebar.markdown(
            create_open_new_page_button("Announcement Board", BULLETIN_IP),
            unsafe_allow_html=True,
        )
